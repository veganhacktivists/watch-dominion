export default function ArrowRight() {
  return (
    <svg
      className="translate-x-0 transform-gpu transition group-hover:translate-x-2"
      width="18"
      height="19"
      viewBox="0 0 18 19"
      fill="none"
