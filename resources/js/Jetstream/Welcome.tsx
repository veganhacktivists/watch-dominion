...
export default function Welcome() {
  return (
    <div>
      <div className="border-gray-200 border-b bg-white p-6 sm:px-20">
        <div>
      ...
      <div className="bg-gray-200 grid grid-cols-1 bg-opacity-25 md:grid-cols-2">
        <div className="p-6">
          <div className="flex items-center">
            ...
            <div className="text-gray-600 ml-4 text-lg font-semibold leading-7">
          ...
          <div className="ml-12">
            ...
            <a href="https://laravel.com/docs">
              <div className="text-indigo-700 mt-3 flex items-center text-sm font-semibold">
                <div>Explore the documentation</div>

                <div className="text-indigo-500 ml-1">
                  <svg
                    viewBox="0 0 20 20"
                    fill="currentColor"
                    className="h-4 w-4"
        ...
        <div className="border-gray-200 border-t p-6 md:border-t-0 md:border-l">
          <div className="flex items-center">
            <svg
              fill="none"
              stroke="currentColor"
        ...
        <div className="border-gray-200 border-t p-6 md:border-l">
          <div className="flex items-center">
            <svg
              fill="none"
              stroke="currentColor"
